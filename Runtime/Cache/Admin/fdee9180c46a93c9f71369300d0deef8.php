        ...
        <article class="module width_full">
            ...
            <div class="module_content">
                <fieldset>
                    <label>所属主分类</label>
                    <select name='pid'>
                        <?php if(is_array($mainclass)): $i = 0; $__LIST__ = $mainclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$main): $mod = ($i % 2 );++$i;?><option value='<?php echo ($main["id"]); ?>'><?php echo ($main["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </fieldset>
                <div class="clear"></div>
                <fieldset>
                    <label>子类</label>
                    <input name='childname' type="text" value=''>
                </fieldset>
                <div class="clear"></div>
                <fieldset>
                    <label>URL</label>
                    <input name='childurl' type="text" value=''>
                </fieldset>
            </div>
            <footer>
