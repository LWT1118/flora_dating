        ...
        <article class="module width_full">
            ...
            <div class="module_content">
                ...
                <fieldset>
                    <label>活动分类</label>
                    <select name='cat'>
                        <?php if(is_array($votes)): $i = 0; $__LIST__ = $votes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </fieldset>
                <div class="clear"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <fieldset>
                    ...
                    <div class="clear"></div>
                    <p align='center'>
                        <?php if(strlen($data['img']) > 0): ?><img class='shop_pic_2' src='__UPLOAD__/vote/thumb300_<?php echo ($data["img"]); ?>' class='img-responsive img-rounded img-thumbnail'>
                            <?php else: ?>
