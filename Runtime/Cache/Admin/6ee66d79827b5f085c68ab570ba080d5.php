...
<section id="main" class="column">
	<form method='post' action='<?php echo U('posUpdate');?>'>
      ...
      <ul class="tabs">
          <li>
            <a href="<?php echo U('roleAdd');?>"><i class='icon-plus'></i> 添加新条目</a>
          </li>
      </ul>
		</header>
		...
		<div class="tab_container">
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr> 
    				...
    				<td><?php echo (($vo["remark"])?($vo["remark"]):'暂无描述'); ?></td> 
    				<td>
              <a class='my-icon' href='<?php echo U('access','rid='.$vo['id']);?>' title="权限分配"><i class='icon-gear'></i></a>
              <a class='my-icon' href='<?php echo U('roleEdit','id='.$vo['id']);?>' title="编辑"><i class='icon-pencil'></i></a>
    					<a class='my-icon' href='javascript:sure("<?php echo U('roleDel','id='.$vo['id']);?>")' title="删除"><i class='icon-trash'></i></a>
            </td> 
