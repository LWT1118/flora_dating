        ...
        <article class="module width_full">
            ...
            <div class="module_content">
                <fieldset style="width:24%; float:left; margin-right:1%; margin-top:0">
                    <label>投票选项主图</label>
                    <input type='hidden' id='img_input' name='img' value='<?php echo ($data["image"]); ?>'>
                    <div class="clear"></div>
                    <div data-toggle="modal" data-target="#myModal" title='修改图片' style='display:block; width:200px; margin:0 auto; overflow:hidden'>
                        <img src="<?php echo ($data["image"]); ?>" class='shop_pic_1 img-responsive img-rounded img-thumbnail'>
                    </div>
                    <label>&nbsp;</label>
                    <div class="clear"></div>
                </fieldset>
                ...
                <fieldset>
                    <label>所属活动</label>
                    <select name='vote_id'>
                         <?php if(is_array($votes)): $i = 0; $__LIST__ = $votes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>' <?php if(($vo["id"]) == $data["vote_id"]): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </fieldset>
                <div class="clear"></div>
                <input type='hidden' id='select_id' name='select_id' value='<?php echo ($data["id"]); ?>'>
                <!-- <fieldset>
                     <label>投票选项详情</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <fieldset>
                    ...
                    <div class="clear"></div>
                    <p align='center'>
                        <?php if($data["image"] != ''): ?><img class='shop_pic_2' src='<?php echo ($data["image"]); ?>' class='img-responsive img-rounded img-thumbnail'>
                            <?php else: ?>
