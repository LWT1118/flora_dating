...
<ul class="toggle">
	...
	<form method='post' action='<?php echo U('pwdUpdate');?>'>
		...
		<article class="module width_full">
			<header>
				...
				<div class="module_content">
						...
						<fieldset>
							<label>当前账户</label>
							<span class='pwd_span'><?php echo ($m['username']); ?><span>
						</fieldset>

						<fieldset>
							<label>当前密码</label>
							<input class='pwd_input' name='p' type="password" placeholder='当前密码'>
						</fieldset>

						<fieldset>
							<label>新密码</label>
							<input class='pwd_input' name='p1' type="password" placeholder='新密码'>
						</fieldset>

						<fieldset>
							<label>确认密码</label>
							<input class='pwd_input' name='p2' type="password" placeholder='确认密码'>
						</fieldset>
