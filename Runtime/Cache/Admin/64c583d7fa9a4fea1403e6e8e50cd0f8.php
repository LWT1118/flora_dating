...
<ul class="toggle">
	...
	<li><a href="<?php echo U('/'.GROUP_NAME.'/Vote/addSelect');?>"><i class='icon-plus'></i> 添加选项</a></li>
...
<fieldset>
	...
	<span class='pwd_span'>http://<?php echo ($_SERVER['HTTP_HOST']); ?>/Wechat/</span>
</fieldset>

<fieldset>
	<label>Token(令牌)</label>
	<input value='<?php echo ($data["token"]); ?>' class='txt_input' name='token' placeholder='Token(令牌)'>
</fieldset>

<fieldset>
	<label>EncodingAESKey(消息加解密密钥)</label>
	<input value='<?php echo ($data["encodingaeskey"]); ?>' class='txt_input' name='encodingaeskey' placeholder='EncodingAESKey(消息加解密密钥)'>
</fieldset>

<fieldset>
	<label>AppID(应用ID)</label>
	<input value='<?php echo ($data["appid"]); ?>' class='txt_input' name='appid' placeholder='AppID(应用ID)'>
</fieldset>

<fieldset>
	<label>AppSecret(应用密钥)</label>
	<input value='<?php echo ($data["appsecret"]); ?>' class='txt_input' name='appsecret' placeholder='AppSecret(应用密钥)'>
</fieldset>
